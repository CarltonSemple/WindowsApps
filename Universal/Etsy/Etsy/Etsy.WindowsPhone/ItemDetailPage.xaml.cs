...
namespace Etsy
{
    ...
    public sealed partial class ItemDetailPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (App.purchased)
                adSection.Visibility = Visibility.Collapsed;
        ...
        private async void addToCart_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            TextBlock tblock = button.Content as TextBlock;
            tblock.Text = "Added to Cart!";
        }
        ...
        {
            this.Frame.Navigate(typeof(ItemDetailPage), relatedItemsList.SelectedItem);
        }
