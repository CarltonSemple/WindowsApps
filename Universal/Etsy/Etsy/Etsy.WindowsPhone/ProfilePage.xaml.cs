...
namespace Etsy
{
    ...
    public sealed partial class ProfilePage : Page
    {
        ...
        /// <summary>
        /// Delete the user's tokens, set the logged_in variable to false, and go back to the home page
        /// </summary>
        ...
        private async void logoutButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                await FileIO.DeleteFile("access_token");
                await FileIO.DeleteFile("access_token_secret");
            }
            catch
            {
            ...
            {
                App.logged_in = false;      // do this regardless
