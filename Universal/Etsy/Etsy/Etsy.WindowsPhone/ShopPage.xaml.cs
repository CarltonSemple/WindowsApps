...
namespace Etsy
{
    ...
    public sealed partial class ShopPage : Page
    {
        ...
        void timer_Tick(object sender, object e)
        {
            ...
            double current_offset = scroller.HorizontalOffset;
            ...
            scrollPosition = scroller.HorizontalOffset;   // update position variable
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.DefaultViewModel["shopName"] = shop.shop_name;
            this.DefaultViewModel["title"] = shop.title;
        ...
        private async Task saveListState()
        {
            ...
            var scroller = FindVisualChild<ScrollViewer>(productList);
            scrollPosition = scroller.HorizontalOffset;                           // save listView position
        ...
        private void orientationCorrections()
        {
            // Get the view state
            ...
            {
                shopPanel.SetValue(Grid.RowProperty, 1);
                shopPanel.SetValue(Grid.RowSpanProperty, 1);
                shopPanel.SetValue(Grid.ColumnSpanProperty, 2);

                productList.SetValue(Grid.RowProperty, 2);
                productList.SetValue(Grid.RowSpanProperty, 1);
                productList.SetValue(Grid.ColumnProperty, 0);
                productList.SetValue(Grid.ColumnSpanProperty, 2);

                bottomMenuPanel.SetValue(Grid.ColumnProperty, 0);
                bottomMenuPanel.SetValue(Grid.ColumnSpanProperty, 2);
            }
            else
            {
                shopPanel.SetValue(Grid.RowProperty, 1);
                shopPanel.SetValue(Grid.RowSpanProperty, 2);
                shopPanel.SetValue(Grid.ColumnSpanProperty, 1);

                productList.SetValue(Grid.RowProperty, 1);
                productList.SetValue(Grid.RowSpanProperty, 2);
                productList.SetValue(Grid.ColumnProperty, 1);
                productList.SetValue(Grid.ColumnSpanProperty, 1);

                bottomMenuPanel.SetValue(Grid.ColumnProperty, 1);
                bottomMenuPanel.SetValue(Grid.ColumnSpanProperty, 1);
            }
        }
