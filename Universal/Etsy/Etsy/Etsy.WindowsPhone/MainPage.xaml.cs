...
namespace Etsy
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            DisplayInformation.AutoRotationPreferences = DisplayOrientations.Portrait;  // Restrict to portrait orientation
        }
        ...
        {
            this.Frame.BackStack.Clear();                                   // clear back button history
            ...
            // Also hide before they log in, making a good first impression
            if (App.purchased || !App.logged_in)
        ...
        private void initial_orientation()
        {
            ...
            if (currentOrientation == "Portrait")  // portrait
            {
                ...
                // name and photo
                usernameBlock.Visibility = Visibility.Collapsed;    // hide the name
            }
            else
            {
                ...
                // name and photo
                usernameBlock.Visibility = Visibility.Visible;    // show the name
            }
        }
        ...
        private void NameAndPhoto_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (App.logged_in == false)
                nameButton.Visibility = Visibility.Collapsed;             // hide if the user isn't logged in
        }
        ...
        private void searchButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            searchButton.SetValue(Grid.RowProperty, 1);             // move search button
            if (searchBoxLandscape.Visibility == Visibility.Visible)
            {
                ...
                { // return to original positions/states
                    searchButton.SetValue(Grid.RowProperty, 0);
                    searchButton.SetValue(Grid.ColumnProperty, 1);
        ...
        private void menuButton_Click(object sender, RoutedEventArgs e)
        {
            if (menuPanel.Margin.Top == -775)
            {
                ...
                visibilityBlocker.Visibility = Visibility.Visible;     // hide everything else
                searchButton.SetValue(Grid.RowProperty, 0);             // return search button to its original place
                searchBoxLandscape.Visibility = Visibility.Collapsed;   // hide search box
            }
            else
            {
                menuPanel.Margin = new Thickness(0, -775, 0, 0);        // Hide menu
                visibilityBlocker.Visibility = Visibility.Collapsed;   // show everything else
            }
        ...
        {
            Loading.ControlProgressRing(products, pRing);     // progress ring
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void browseListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
                 Frame.Navigate(typeof(SubSectionPage), selectedSection));
        }
        ...
        /// <summary>
        /// Hide menu
        /// Return the searchbutton to its original position
        /// Hide that and the searchbox as well
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            menuPanel.Margin = new Thickness(0, -775, 0, 0);        // Hide menu
            searchButton.SetValue(Grid.RowProperty, 0);             // return search button
            searchBoxLandscape.Visibility = Visibility.Collapsed;   // hide search box
            visibilityBlocker.Visibility = Visibility.Collapsed;    // show everything else
        }
